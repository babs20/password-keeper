$(() => {
  ...
  <div class="w-10/12 mx-auto h-full flex justify-center">
    <div class="all-accounts mx-5 mt-10 w-11/12 flex flex-col items-center pb-8">
      ...
      <div id="no-accounts-container"></div>
        <div class="accounts-table w-full overflow-y-auto border-b-2 border-t-2 border-gray-400">
    ...
    getAllAccounts(data)
      .then(accountsArr => {
        const $emptyAccountsTable = $(`
          <div class="no-accounts-alert flex flex-col mb-3 w-full bg-alertRed rounded-lg">
            <h4 class="no-accounts-alert-message text-white p-2 font-bold text-sm">
