$(() => {
  ...
  <div class="w-10/12 h-100 mx-auto flex flex-col items-center justify-start mb-8 h-100">
    ...
    getOrgInfo()
      .then(json => {
        ...
        <div class="edit-org-header-section w-full">
          <h2 class="edit-org font-sans text-2xl font-bold w-full my-5 border-l-8 border-black pl-4">Edit Organization
            Information</h2>
          <h3
          ...
          <div class="edit-org-form_field-wrapper flex flex-col w-full">
            ...
            <div id="generator" class="flex justify-between w-full">
              <input type="password" name="password" placeholder="Password"
                class="org-password-field mt-2 border-2 rounded border-gray-400 focus:outline-none focus:ring-1 focus:border-button w-3/4 mr-3 pr-16 pl-1 py-1">
        ...
        <div class="edit-org-form_field-wrapper flex flex-col ml-3 mr-3 mb-3 w-full">
          ...
          <input type="password" name="confirm-password" placeholder="Confirm Password"
            class="confirm-org-password input">
        </div>

        <div class="edit-org-form_field-wrapper flex flex-col ml-3 mr-3 mb-3 w-full pt-2 w-full border-t-2 border-gray-600">
          <label for="current-master-password" class="label">Current Master Password</label>
          <input type="password" name="current_master_password" placeholder="Master Password"
            class="current-master-password input">
        </div>

        <div class="edit-org-form_field-wrapper flex flex-col ml-3 mr-3 mb-3 w-full">
          <label for="new-master-password" class="label">New Master Password</label>
          <input type="password" name="new_master_password" placeholder="New Master Password"
            class="new-master-password input">
        </div>

        <div class="edit-org-form_field-wrapper flex flex-col ml-3 mr-3 mb-3 w-full">
          <label for="confirm-master-password" class="label">Confirm Master Password</label>
          <input type="password" name="confirm-master-password" placeholder="Confirm Master Password"
            class="confirm-master-password input">
        </div>

        <div class="edit-org-form_field-wrapper flex flex-col ml-3 mr-3 mb-3 w-full">
          <button type="submit"
            class="save-org-info rounded p-1 bg-button w-full text-white hover:bg-hoverBlue mt-1.5 font-bold">Save</button>
        </div>
